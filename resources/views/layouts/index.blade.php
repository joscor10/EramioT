		...
		@foreach($productos as $producto)
						...
						<div class="col-sm" style="padding-left: 50px;">
							<div class="card" style="width: 18rem;">
							  <img style="height: 200px; width: 200px; " src="imagenes/{{$producto->imagen}}" class="card-img-top mx-auto d-block" alt="...">
							  ...
							  <div class="card-body" style="">
							    <h3 class="card-title" style="font-family: 'Shadows Into Light', cursive; font-size: 35px;">{{$producto->nombre}}</h3>
							    <p class="card-text text-left" style="font-size: 20px;">{{$producto->descripcion_corta}}</p>
							    <p class="card-text text-left" style="font-size: 20px;">Talla {{$producto->talla}}</p>

							    <div class="form-inline">
							    	<p class="" style="font-size: 25px;">${{number_format($producto->precio_venta,2,",",".")}} &nbsp</p>
							    	<p class="" style="font-size: 20px;"><strike>${{number_format($producto->precio,2,",",".")}}</strike> </p>
