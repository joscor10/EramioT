    ...
    <div class="row ">
        ...
        <div class="col-md-2 float-left col-2 pl-0 pr-0 c width border">
            ...
            <div class="list-group border-0 card text-center text-md-left">
                ...
                <a href="#" style="font-size: 25px; color: #6c757d " class="nav-link list-group-item d-inline-block collapsed" data-parent="#sidebar"><i class="fa fa-heart"></i> <span class="d-none d-md-inline">Compras</span></a>
                ...
                <a href="#" style="font-size: 25px; color: #6c757d " class="nav-link list-group-item d-inline-block collapsed" data-parent="#sidebar"><i class="fa fa-clock-o"></i> <span class="d-none d-md-inline">Link</span></a>
